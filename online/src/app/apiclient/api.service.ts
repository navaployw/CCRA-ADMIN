...
export class ApiService {
  ...
  // public hostnameApi: string = 'http://localhost:8082/ccraapiadmin/api';
  public hostnameApi: string = data.hostnameApi;
  public hostnameAuthen: string = data.hostnameAuthen;
  // public hostnameApi: string = 'http://10.11.60.228:8082/ccraadmin/api';
  // public hostnameAuthen: string = 'http://10.11.60.228:8080/ccraapiauth';
  // public hostnameApi: string = 'http://10.220.15.122:8082/ccraadmin/api';
  // public hostnameAuthen: string = 'http://10.220.15.122:8080/ccraapiauth';
  ...
  public options = {
          headers: {
              //"Authorization": 'Bearer '+this.sessionSt.retrieve('access_token')
          }
  }
  ...
  ) 
  {
    ...
    //  console.log('API Client constructore...');
     //this.authenticate();
   }
