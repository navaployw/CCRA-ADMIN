...
import com.arg.ccra.adminonline.utils.PreferLanguage;
...
public class User {
    ...
    public String toString() {
        return "User{" + "loginTime=" + loginTime + ", AIID=" + AIID + ", CCRAID=" + CCRAID + ", groupID=" + groupID + ", groupAIID=" + groupAIID + ", uID=" + uID + ", uniqueKey=" + uniqueKey + ", comapnyID=" + comapnyID + ", reportSegmentList=" + reportSegmentList + ", preferLanguage=" + preferLanguage + ", AIDescription=" + AIDescription + ", AINameEnglish=" + AINameEnglish + ", AINameLocal=" + AINameLocal + ", addressEng1=" + addressEng1 + ", addressEng2=" + addressEng2 + ", addressEng3=" + addressEng3 + ", addressLocal=" + addressLocal + ", areaCode=" + areaCode + ", cityEnglish=" + cityEnglish + ", cityLocal=" + cityLocal + ", contributorCode=" + contributorCode + ", country=" + country + ", countryCode=" + countryCode + ", description=" + description + ", email=" + email + ", faxNO=" + faxNO + ", groupDescription=" + groupDescription + ", groupNameEnglish=" + groupNameEnglish + ", groupNameLocal=" + groupNameLocal + ", phoneNO=" + phoneNO + ", provinceEnglish=" + provinceEnglish + ", provinceLocal=" + provinceLocal + ", url=" + url + ", userID=" + userID + ", userNameEnglish=" + userNameEnglish + ", userNameLocal=" + userNameLocal + ", adminFlag=" + adminFlag + ", cannotChangePassword=" + cannotChangePassword + ", requiredChangePassword=" + requiredChangePassword + ", idleTime=" + idleTime + ", mailbox=" + mailbox + ", rowPerPage=" + rowPerPage + ", password=" + password + ", expireDate=" + expireDate + ", disabled=" + disabled + '}';
    }
